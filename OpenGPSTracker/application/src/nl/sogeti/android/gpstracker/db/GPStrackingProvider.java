...
/**
 * Goal of this Content Provider is to make the GPS Tracking information uniformly available to this application and even other applications. The GPS-tracking database can hold, tracks, segments or
 * waypoints
 * <p>
   ...
   public int update(Uri uri, ContentValues givenValues, String selection, String[] selectionArgs)
   {
      ...
      switch (match)
      {
         case TRACK_ID:
            ...
            if (givenValues.containsKey(Tracks.NAME))
            {
